    ...
    <form method="POST" action="{{ route('sections.update', $section) }}" class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="row g-3 mt-3">
                ...
                <div class="col-md-6">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="has_trial" name="has_trial" value="1" {{ old('has_trial', $section->has_trial) ? 'checked' : '' }}>
                ...
                <div class="col-md-6" id="trial-free-container" style="display: none;">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="trial_is_free" name="trial_is_free" value="1" {{ old('trial_is_free', $section->trial_is_free) ? 'checked' : '' }}>
                ...
                <div class="col-md-6" id="trial-price-container" style="display: none;">
                    ...
                    <input id="trial_price" name="trial_price" type="number" step="0.01" min="0" class="form-control" value="{{ old('trial_price', $section->trial_price) }}">
                </div>
            </div>
